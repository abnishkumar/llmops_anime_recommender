...
- **Clone your GitHub repo**
  ...
  ```bash
  git clone https://github.com/abnishkumar/llmops_anime_recommender.git
  ls
  cd TESTING-9
...
```bash
git config --global user.email "abnish.kumar4@gmail.com"
git config --global user.name "abnishkumar"
